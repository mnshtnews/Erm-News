-- ─────────────────────────────────────────────────────────────────────────────
-- Eram News Monitor — Initial Database Schema
...
COMMENT ON TABLE articles IS 'Eram News (إرم نيوز) sports articles scraped and classified by the monitoring system.';
